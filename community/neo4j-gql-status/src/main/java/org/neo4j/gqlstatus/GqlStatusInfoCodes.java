...
public enum GqlStatusInfoCodes implements GqlStatusInfo {
    ...
    STATUS_22NC2(
            new GqlStatus("22NC2"),
            "The node element type { %s } must contain one or more implied labels, or define at least one property type.",
            new GqlParams.GqlParam[] {GqlParams.StringParam.label},
            emptyMap(),
            Condition.DATA_EXCEPTION,
            "node element type is empty",
            ErrorClassification.CLIENT_ERROR),
    STATUS_22NC3(
            new GqlStatus("22NC3"),
            "The relationship element type { %s } must define a node element type for source or destination, or define at least one property type.",
            new GqlParams.GqlParam[] {GqlParams.StringParam.relType},
            emptyMap(),
            Condition.DATA_EXCEPTION,
            "relationship element type is empty",
            ErrorClassification.CLIENT_ERROR),
    STATUS_22NC4(
            new GqlStatus("22NC4"),
            ...
            Condition.DATA_EXCEPTION,
            "a label cannot both identifying and implied",
            ErrorClassification.CLIENT_ERROR),
    STATUS_22NC5(
            new GqlStatus("22NC5"),
            "The { %s } type element referenced by { %s } was not found.",
    ...
    STATUS_22NC6(
            new GqlStatus("22NC6"),
            "The independent constraint { %s } was defined using the same label { %s } as a node type element.",
            new GqlParams.GqlParam[] {GqlParams.StringParam.constrDescrOrName, GqlParams.StringParam.label},
            emptyMap(),
            Condition.DATA_EXCEPTION,
            "independent constraint defined on node type element label",
            ErrorClassification.CLIENT_ERROR),
    STATUS_22NC7(
            new GqlStatus("22NC7"),
            "The independent constraint { %s } was defined using the same relationship type { %s } as a relationship type element.",
            new GqlParams.GqlParam[] {GqlParams.StringParam.constrDescrOrName, GqlParams.StringParam.relType},
            emptyMap(),
            Condition.DATA_EXCEPTION,
            "independent constraint defined on relationship type element relationship type",
            ErrorClassification.CLIENT_ERROR),
    STATUS_22NC8(
            new GqlStatus("22NC8"),
            ...
            emptyMap(),
            Condition.DATA_EXCEPTION,
            "constraint does not have a label or relationship type",
            ErrorClassification.CLIENT_ERROR),
    STATUS_22NC9(
            new GqlStatus("22NC9"),
            "The graph type includes a label, relationship type or alias with name { %s } more than once.",
    ...
    STATUS_22NCA(
            ...
            new GqlParams.GqlParam[] {
                GqlParams.StringParam.entityType, GqlParams.StringParam.context, GqlParams.StringParam.msg
            },
            emptyMap(),
            Condition.DATA_EXCEPTION,
    ...
    STATUS_22NCB(
            ...
            emptyMap(),
            Condition.DATA_EXCEPTION,
            "graph type constraint is missing an alias",
            ErrorClassification.CLIENT_ERROR),
    STATUS_25000(
            new GqlStatus("25000"),
            "",
