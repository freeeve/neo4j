...
public class Cypher25Lexer extends Lexer {
	...
	public static final int
		...
		REPEATABLE=235, REPLACE=236, REPORT=237, REQUIRE=238, REQUIRED=239, RESTRICT=240, 
		RETRY=241, RETURN=242, REVOKE=243, ROLE=244, ROLES=245, ROW=246, ROWS=247, 
		RPAREN=248, SCAN=249, SEC=250, SECOND=251, SECONDARY=252, SECONDARIES=253, 
		SECONDS=254, SEEK=255, SEMICOLON=256, SERVER=257, SERVERS=258, SET=259, 
		SETTING=260, SETTINGS=261, SHORTEST_PATH=262, SHORTEST=263, SHOW=264, 
		SIGNED=265, SINGLE=266, SKIPROWS=267, START=268, STARTS=269, STATUS=270, 
		STOP=271, STRING=272, SUPPORTED=273, SUSPENDED=274, TARGET=275, TERMINATE=276, 
		TEXT=277, THEN=278, TIME=279, TIMES=280, TIMESTAMP=281, TIMEZONE=282, 
		TO=283, TOPOLOGY=284, TRAILING=285, TRANSACTION=286, TRANSACTIONS=287, 
		TRAVERSE=288, TRIM=289, TRUE=290, TYPE=291, TYPED=292, TYPES=293, UNION=294, 
		UNIQUE=295, UNIQUENESS=296, UNWIND=297, URL=298, USE=299, USER=300, USERS=301, 
		USING=302, VALUE=303, VARCHAR=304, VECTOR=305, VERTEX=306, WAIT=307, WHEN=308, 
		WHERE=309, WITH=310, WITHOUT=311, WRITE=312, XOR=313, YIELD=314, ZONE=315, 
		ZONED=316, IDENTIFIER=317, EXTENDED_IDENTIFIER=318, ARROW_LINE=319, ARROW_LEFT_HEAD=320, 
		ARROW_RIGHT_HEAD=321, ErrorChar=322;
