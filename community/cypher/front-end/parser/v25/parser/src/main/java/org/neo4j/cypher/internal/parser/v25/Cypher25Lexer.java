...
public class Cypher25Lexer extends Lexer {
	...
	public static final int
		...
		LEADING=148, LET=149, LIMITROWS=150, LIST=151, LOAD=152, LOCAL=153, LOOKUP=154, 
		LPAREN=155, LT=156, MANAGEMENT=157, MAP=158, MATCH=159, MERGE=160, MINUS=161, 
		PERCENT=162, INVALID_NEQ=163, NEQ=164, NAME=165, NAMES=166, NAN=167, NFC=168, 
		NFD=169, NFKC=170, NFKD=171, NEW=172, NODE=173, NODETACH=174, NODES=175, 
		NONE=176, NORMALIZE=177, NORMALIZED=178, NOT=179, NOTHING=180, NOWAIT=181, 
		NULL=182, OF=183, OFFSET=184, ON=185, ONLY=186, OPTIONAL=187, OPTIONS=188, 
		OPTION=189, OR=190, ORDER=191, PASSWORD=192, PASSWORDS=193, PATH=194, 
		PATHS=195, PLAINTEXT=196, PLUS=197, PLUSEQUAL=198, POINT=199, POPULATED=200, 
		POW=201, PRIMARY=202, PRIMARIES=203, PRIVILEGE=204, PRIVILEGES=205, PROCEDURE=206, 
		PROCEDURES=207, PROPERTIES=208, PROPERTY=209, PROVIDER=210, PROVIDERS=211, 
		QUESTION=212, RANGE=213, RBRACKET=214, RCURLY=215, READ=216, REALLOCATE=217, 
		REDUCE=218, RENAME=219, REGEQ=220, REL=221, RELATIONSHIP=222, RELATIONSHIPS=223, 
		REMOVE=224, REPEATABLE=225, REPLACE=226, REPORT=227, REQUIRE=228, REQUIRED=229, 
		RESTRICT=230, RETRY=231, RETURN=232, REVOKE=233, ROLE=234, ROLES=235, 
		ROW=236, ROWS=237, RPAREN=238, SCAN=239, SEC=240, SECOND=241, SECONDARY=242, 
		SECONDARIES=243, SECONDS=244, SEEK=245, SEMICOLON=246, SERVER=247, SERVERS=248, 
		SET=249, SETTING=250, SETTINGS=251, SHORTEST_PATH=252, SHORTEST=253, SHOW=254, 
		SIGNED=255, SINGLE=256, SKIPROWS=257, START=258, STARTS=259, STATUS=260, 
		STOP=261, STRING=262, SUPPORTED=263, SUSPENDED=264, TARGET=265, TERMINATE=266, 
		TEXT=267, THEN=268, TIME=269, TIMES=270, TIMESTAMP=271, TIMEZONE=272, 
		TO=273, TOPOLOGY=274, TRAILING=275, TRANSACTION=276, TRANSACTIONS=277, 
		TRAVERSE=278, TRIM=279, TRUE=280, TYPE=281, TYPED=282, TYPES=283, UNION=284, 
		UNIQUE=285, UNIQUENESS=286, UNWIND=287, URL=288, USE=289, USER=290, USERS=291, 
		USING=292, VALUE=293, VARCHAR=294, VECTOR=295, VERTEX=296, WAIT=297, WHEN=298, 
		WHERE=299, WITH=300, WITHOUT=301, WRITE=302, XOR=303, YIELD=304, ZONE=305, 
		ZONED=306, IDENTIFIER=307, EXTENDED_IDENTIFIER=308, ARROW_LINE=309, ARROW_LEFT_HEAD=310, 
		ARROW_RIGHT_HEAD=311, ErrorChar=312;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"LE", "LEADING", "LET", "LIMITROWS", "LIST", "LOAD", "LOCAL", "LOOKUP", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"MINUS", "PERCENT", "INVALID_NEQ", "NEQ", "NAME", "NAMES", "NAN", "NFC", 
			"NFD", "NFKC", "NFKD", "NEW", "NODE", "NODETACH", "NODES", "NONE", "NORMALIZE", 
