...
public class Cypher25Lexer extends Lexer {
	...
	public static final int
		...
		RPAREN=263, SCAN=264, SCORE=265, SEARCH=266, SEC=267, SECOND=268, SECONDARY=269, 
		SECONDARIES=270, SECONDS=271, SEEK=272, SEMICOLON=273, SERVER=274, SERVERS=275, 
		SET=276, SETTING=277, SETTINGS=278, SHARD=279, SHARDS=280, SHORTEST_PATH=281, 
		SHORTEST=282, SHOW=283, SIGNED=284, SINGLE=285, SKIPROWS=286, START=287, 
		STARTS=288, STATUS=289, STOP=290, STRING=291, SUPPORTED=292, SUSPENDED=293, 
		TARGET=294, TERMINATE=295, TEXT=296, THEN=297, TIME=298, TIMES=299, TIMESTAMP=300, 
		TIMEZONE=301, TO=302, TOPOLOGY=303, TRAILING=304, TRANSACTION=305, TRANSACTIONS=306, 
		TRAVERSE=307, TRIM=308, TRUE=309, TYPE=310, TYPED=311, TYPES=312, UNION=313, 
		UNIQUE=314, UNIQUENESS=315, UNWIND=316, URL=317, USE=318, USER=319, USERS=320, 
		USING=321, VALUE=322, VARCHAR=323, VECTOR=324, VECTOR_DISTANCE=325, VECTOR_NORM=326, 
		VERTEX=327, WAIT=328, WHEN=329, WHERE=330, WITH=331, WITHOUT=332, WRITE=333, 
		XOR=334, YIELD=335, ZONE=336, ZONED=337, IDENTIFIER=338, EXTENDED_IDENTIFIER=339, 
		ARROW_LINE=340, ARROW_LEFT_HEAD=341, ARROW_RIGHT_HEAD=342, ErrorChar=343;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"VECTOR_DISTANCE", "VECTOR_NORM", "VERTEX", "WAIT", "WHEN", "WHERE", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"ENCRYPTED", "EUCLIDEAN", "EUCLIDEAN_SQUARED", "END", "ENDS", "EQ", "EXECUTABLE", 
			...
			"TIMESTAMP", "TIMEZONE", "TO", "TOPOLOGY", "TRAILING", "TRANSACTION", 
