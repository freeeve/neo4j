...
public class Cypher25Lexer extends Lexer {
	...
	public static final int
		...
		FLOAT=109, FLOAT64=110, FLOAT32=111, FOR=112, FOREACH=113, FROM=114, FULLTEXT=115, 
		FUNCTION=116, FUNCTIONS=117, GE=118, GRANT=119, GRAPH=120, GRAPHS=121, 
		GROUP=122, GROUPS=123, GT=124, HEADERS=125, HOME=126, ID=127, IF=128, 
		IMPERSONATE=129, IMMUTABLE=130, IN=131, INDEX=132, INDEXES=133, INF=134, 
		INFINITY=135, INSERT=136, INT=137, INT64=138, INT32=139, INT16=140, INT8=141, 
		INTEGER=142, INTEGER64=143, INTEGER32=144, INTEGER16=145, INTEGER8=146, 
		IS=147, JOIN=148, KEY=149, LABEL=150, LABELS=151, AMPERSAND=152, EXCLAMATION_MARK=153, 
		LANGUAGE=154, LBRACKET=155, LCURLY=156, LE=157, LEADING=158, LET=159, 
		LIMITROWS=160, LIST=161, LOAD=162, LOCAL=163, LOOKUP=164, LPAREN=165, 
		LT=166, MANAGEMENT=167, MAP=168, MATCH=169, MERGE=170, MINUS=171, PERCENT=172, 
		INVALID_NEQ=173, NEQ=174, NAME=175, NAMES=176, NAN=177, NFC=178, NFD=179, 
		NFKC=180, NFKD=181, NEW=182, NODE=183, NODETACH=184, NODES=185, NONE=186, 
		NORMALIZE=187, NORMALIZED=188, NOT=189, NOTHING=190, NOWAIT=191, NULL=192, 
		OF=193, OFFSET=194, ON=195, ONLY=196, OPTIONAL=197, OPTIONS=198, OPTION=199, 
		OR=200, ORDER=201, PASSWORD=202, PASSWORDS=203, PATH=204, PATHS=205, PLAINTEXT=206, 
		PLUS=207, PLUSEQUAL=208, POINT=209, POPULATED=210, POW=211, PRIMARY=212, 
		PRIMARIES=213, PRIVILEGE=214, PRIVILEGES=215, PROCEDURE=216, PROCEDURES=217, 
		PROPERTIES=218, PROPERTY=219, PROVIDER=220, PROVIDERS=221, QUESTION=222, 
		RANGE=223, RBRACKET=224, RCURLY=225, READ=226, REALLOCATE=227, REDUCE=228, 
		RENAME=229, REGEQ=230, REL=231, RELATIONSHIP=232, RELATIONSHIPS=233, REMOVE=234, 
		REPEATABLE=235, REPLACE=236, REPLICA=237, REPLICAS=238, REPORT=239, REQUIRE=240, 
		REQUIRED=241, RESTRICT=242, RETRY=243, RETURN=244, REVOKE=245, ROLE=246, 
		ROLES=247, ROW=248, ROWS=249, RPAREN=250, SCAN=251, SEC=252, SECOND=253, 
		SECONDARY=254, SECONDARIES=255, SECONDS=256, SEEK=257, SEMICOLON=258, 
		SERVER=259, SERVERS=260, SET=261, SETTING=262, SETTINGS=263, SHARD=264, 
		SHARDS=265, SHORTEST_PATH=266, SHORTEST=267, SHOW=268, SIGNED=269, SINGLE=270, 
		SKIPROWS=271, START=272, STARTS=273, STATUS=274, STOP=275, STRING=276, 
		SUPPORTED=277, SUSPENDED=278, TARGET=279, TERMINATE=280, TEXT=281, THEN=282, 
		TIME=283, TIMES=284, TIMESTAMP=285, TIMEZONE=286, TO=287, TOPOLOGY=288, 
		TRAILING=289, TRANSACTION=290, TRANSACTIONS=291, TRAVERSE=292, TRIM=293, 
		TRUE=294, TYPE=295, TYPED=296, TYPES=297, UNION=298, UNIQUE=299, UNIQUENESS=300, 
		UNWIND=301, URL=302, USE=303, USER=304, USERS=305, USING=306, VALUE=307, 
		VARCHAR=308, VECTOR=309, VERTEX=310, WAIT=311, WHEN=312, WHERE=313, WITH=314, 
		WITHOUT=315, WRITE=316, XOR=317, YIELD=318, ZONE=319, ZONED=320, IDENTIFIER=321, 
		EXTENDED_IDENTIFIER=322, ARROW_LINE=323, ARROW_LEFT_HEAD=324, ARROW_RIGHT_HEAD=325, 
		ErrorChar=326;
