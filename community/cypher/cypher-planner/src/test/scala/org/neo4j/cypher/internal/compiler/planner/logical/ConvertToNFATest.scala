...
class ConvertToNFATest extends CypherFunSuite with AstConstructionTestSupport {
  ...
  test("create NFA with predicates that do not depend on path variables") {
    ...
    val expectedNfa = new TestNFABuilder(0, "start")
      ...
      .addTransition(4, 5, "(d) (`  UNNAMED3`)")
      .addTransition(5, 6, "(`  UNNAMED3`) (end)")
      .addTransition(5, 5, "(`  UNNAMED3`)-[`  r3@0`:R]->(`  UNNAMED3`)")
      .setFinalState(6)
      .build()
  ...
  test("(start)-[r:R*2..]->(end)") {
    ...
    val expectedNfa = new TestNFABuilder(0, "start")
      .addTransition(0, 1, "(start) (`  UNNAMED1`)")
      .addTransition(1, 2, "(`  UNNAMED1`)-[`  r@0`:R]->(`  UNNAMED2`)")
      .addTransition(2, 3, "(`  UNNAMED2`)-[`  r@0`:R]->(`  UNNAMED4`)")
      .addTransition(3, 3, "(`  UNNAMED4`)-[`  r@0`:R]->(`  UNNAMED4`)")
      .addTransition(3, 4, "(`  UNNAMED4`) (end)")
      .setFinalState(4)
      .build()
  ...
  test("(start)-[r:R*3..]->(end)") {
    ...
    val expectedNfa = new TestNFABuilder(0, "start")
      ...
      .addTransition(1, 2, "(`  UNNAMED1`)-[`  r@0`:R]->(`  UNNAMED2`)")
      .addTransition(2, 3, "(`  UNNAMED2`)-[`  r@0`:R]->(`  UNNAMED4`)")
      .addTransition(3, 4, "(`  UNNAMED4`)-[`  r@0`:R]->(`  UNNAMED6`)")
      .addTransition(4, 4, "(`  UNNAMED6`)-[`  r@0`:R]->(`  UNNAMED6`)")
      .addTransition(4, 5, "(`  UNNAMED6`) (end)")
      .setFinalState(5)
      .build()
  ...
  test("(start)-[r:R*2..3]->(end)") {
    ...
    val expectedNfa = new TestNFABuilder(0, "start")
      ...
      .addTransition(2, 3, "(`  UNNAMED2`)-[`  r@0`:R]->(`  UNNAMED4`)")
      .addTransition(3, 4, "(`  UNNAMED4`)-[`  r@0`:R]->(`  UNNAMED6`)")
      .addTransition(3, 5, "(`  UNNAMED4`) (end)")
      .addTransition(4, 5, "(`  UNNAMED6`) (end)")
      .setFinalState(5)
      .build()
  ...
  test("(start:Label)-[r:R|T*2..3 {prop: 2}]->(end {prop: 42})") {
    ...
    val expectedNfa = new TestNFABuilder(0, "start")
      ...
      .addTransition(2, 3, "(`  UNNAMED2`)-[`  r@0`:R|T]->(`  UNNAMED4`)")
      .addTransition(3, 4, "(`  UNNAMED4`)-[`  r@0`:R|T]->(`  UNNAMED6`)")
      .addTransition(1, 5, "(`  UNNAMED1`) (end WHERE end.prop IN [42])")
      .addTransition(2, 5, "(`  UNNAMED2`) (end WHERE end.prop IN [42])")
      .addTransition(3, 5, "(`  UNNAMED4`) (end WHERE end.prop IN [42])")
      .addTransition(4, 5, "(`  UNNAMED6`) (end WHERE end.prop IN [42])")
      .setFinalState(5)
      .build()
