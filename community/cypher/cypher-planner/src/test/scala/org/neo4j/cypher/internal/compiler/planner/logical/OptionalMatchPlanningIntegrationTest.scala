...
abstract class OptionalMatchPlanningIntegrationTest(queryGraphSolverSetup: QueryGraphSolverSetup)
  ...
  test(
    ...
    val expected = new LogicalPlanBuilder()
      ...
      .|.relationshipTypeScan("(anon_1)-[anon_0:REL]-()", IndexOrderNone, "n0", "n1")
      .cartesianProduct()
      .|.allNodeScan("n1")
      .allNodeScan("n0")
      .build()
  ...
  test(
    ...
    val expected = new LogicalPlanBuilder()
      ...
      .apply()
      .|.optional("n0", "n1")
      .|.filterExpression(equals(v"n0", v"anon_0"), assertIsNode("n1"))
      .|.relationshipByIdSeek("(anon_0)-[r]-()", Set("n0", "n1"), 0)
      .cartesianProduct()
      .|.allNodeScan("n1")
      .allNodeScan("n0")
      .build()
  ...
  test(
    ...
    val expected = new LogicalPlanBuilder()
      ...
      .|.optional("n0", "n1")
      .|.filterExpression(equals(v"n0", v"anon_0"), assertIsNode("n1"))
      .|.relationshipByIdSeek("()-[r]->(anon_0)", Set("n0", "n1"), 42)
      .cartesianProduct()
      .|.allNodeScan("n1")
      .allNodeScan("n0")
      .build()
